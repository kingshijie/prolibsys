...
CREATE TABLE IF NOT EXISTS `plib_prolib` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='题库' AUTO_INCREMENT=35 ;
...
(28, 'sdkfjewklnzxjkvaewfsag#1#2#sdgsda#sdgsdaf', 'SDAFWEXXZC', 1, 1, 0, 0),
(29, 'big apple#28', '', 4, 1, 0, 0),
(30, 'sdfas', 'sdagsdf', 3, 1, 0, 0),
(31, '#28#30', '', 4, 1, 0, 0),
(32, 'sadgsd', 'gsadfas', 3, 1, 0, 0),
(33, 'sadgsad', 'fsadf', 5, 1, 0, 0),
(34, 'fsafsdvxzv#32#33', '', 4, 1, 0, 0);
