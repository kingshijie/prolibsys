<?php if(!defined('IN_PLIB')) exit('Access Denied'); checktplrefresh('/var/www/randy/PHP/prolibsys/templates/default/admin//problem.htm', 1292124767); ?>
...
<?php } elseif($op == 'show_edit') { ?>
<form action="admincp.php?ac=problem&amp;op=edit_pro&amp;typeid=<?php echo $proedit['typeid']; ?>" method="post"><?php echo show_edit_pro($pid); ?></form>
<?php } ?>
</div>